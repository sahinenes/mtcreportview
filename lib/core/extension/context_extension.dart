...
extension ThemeExtension on BuildContext {
  ...
  TextStyle get textStyle => const TextStyle(fontFamily: ApplicationConstants.FONT_FAMILY, fontWeight: FontWeight.w500, fontSize: 14);
  TextStyle get textStyleTitle => const TextStyle(fontFamily: ApplicationConstants.FONT_FAMILY, fontWeight: FontWeight.w500, fontSize: 18);
  TextStyle get textStyleBody => const TextStyle(fontFamily: ApplicationConstants.FONT_FAMILY, fontWeight: FontWeight.w500, fontSize: 14);
}
